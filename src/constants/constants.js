export const projects = [
  {
    ...
    description: "A command-line application that dynamically generates a professional README.md file from a user's input using the Inquirer package.",
      ...
      tags: ['Nodejs', 'Javascript', 'Inquirer'],
    source: 'https://github.com/DaveToth77/readme-generator',
    visit: 'https://github.com/DaveToth77/readme-generator',
    id: 0,
  },
  {
    ...
    source: 'https://github.com/DaveToth77/Employee-Tracker',
    visit: 'https://github.com/DaveToth77/Employee-Tracker',
    id: 1,
  },
  {
    title: 'Emprise',
